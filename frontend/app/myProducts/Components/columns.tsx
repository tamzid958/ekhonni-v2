...
async function handleApprove(bidId: number) {
  try {
    const token = `eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJuYXJ2aW9hbHZpQGdtYWlsLmNvbSIsImlhdCI6MTczODU4MzUyMCwiZXhwIjoxNzM4NTg5NTIwfQ.gqLgINdyQiqIj_XGjIvadb38o0dMoaT-dXv7e72S9CM`;
